...
// default setup of morgan 
app.use(morgan('dev'));
// cookie name, keys used to encrypt and decrypt as a sign
...
app.use('/', serve, setup(swaggerJsDocs));  // interface at '/'
...
io.adapter(redis({ host: '127.0.0.1', port: 6379 })); // use redis as message broker hence est. redis server
